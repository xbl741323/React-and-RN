          ...
          (<View style={styles.modifyForm}>
            <View style={styles.modifyFormItem}>
              ...
              <View style={[styles.codeContain, styles.finalCodeText]}>
                <TextInput keyboardType="default" autoCapitalize={'none'} secureTextEntry={true} value={formInfo.newPwd} onBlur={(e) => checkNewPwd(e)} onChangeText={(e) => changeNewPwdInput(e)} style={[styles.modifyInput, formInfo.newPwdError && newPwdBlur ? styles.formErrorSty : '', styles.finalText]} placeholder='请输入6-16位字母+数字组合密码'></TextInput>
                {formInfo.newPwdError && newPwdBlur ? (<Text style={styles.errorText}>请输入6-16位字母+数字组合密码</Text>) : ''}
              </View>
            </View>
            <View style={styles.modifyFormItem}>
