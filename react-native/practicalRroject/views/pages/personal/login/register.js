          ...
          <View style={styles.contain}>
            ...
            <View style={styles.formSty}>
              ...
              <View style={[styles.formItem, pwdError && pwdBlur ? styles.formErrorSty : '']}>
                ...
                <Text style={styles.errorText}>{pwdError && pwdBlur ? '请输入6-16位字母+数字组合密码' : ''}</Text>
                <View style={styles.formOtherItem}>
                  <TextInput underlineColorAndroid={'transparent'} maxLength={16} onBlur={(e) => checkPwd(e)} onChangeText={(e) => changeForm(3, e)} value={userForm.pwd} style={styles.formItemInput} secureTextEntry={pwd} placeholderTextColor='#B7B4B4' placeholder="请输入6-16位字母+数字组合密码"></TextInput>
            ...
            <View style={styles.tipContain}>
              ...
              <View style={styles.tipStyContain}>
                <Text style={styles.tipSty}>注册后自动登录，勾选即代表您已阅读并同意</Text>
                <Text style={styles.tipActiveSty}>《用户注册</Text>
                <View style={[styles.tipStyContain, styles.padTop]}>
                  <Text style={styles.tipActiveSty}>协议》</Text>
